  ...
  return (
    <div>
      ...
      <Routes>
        ...
        {/*Go to MonitorComponent.tsc i.e. monitoring page*/}
        <Route
          path="/login"
          element={<LoginComponent onLogin={handleLogin} />}
        />{" "}
        {/* pass handleLogin as onLogin */}
        <Route path="/doctors/:SSN" element={<DoctorsPage />} />{" "}
        {/* using /doctors/12 -> fake SSN for testing purpose, to be replaced */}
